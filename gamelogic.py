...
class GameLogic:
    ...
    pygame.mixer.init()
    up = False
    enemyList = {"grass":[], "lava":[], "ocean":[], "Boss1":[], "Boss2":[], "Boss3":[], "Boss4":[], "Boss5": [], "Boss6": [],"jungle":[], "snow":[], "Boss7":[]}
    itemlist = {"grass":[], "lava":[], "ocean":[],"Boss1":[],"Boss2":[], "Boss3":[],"Boss4":[],"Boss5": [],"Boss6": [], "jungle":[], "snow":[], "Boss7":[]}
    objects = {"grass":[], "lava":[], "ocean":[], "Boss1":[],"Boss2":[], "Boss3":[], "Boss4":[], "Boss5": [],"Boss6": [],"jungle":[], "snow":[], "Boss7":[]}

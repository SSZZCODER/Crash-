...
def main():
    ...
    spawnskeleton = spawner(0, 600, 11) #change   this
    ...
    energy = pygame.image.load('images/energy.png')
    energy = pygame.transform.scale(energy, (65, 65))
    GameLogic.current_chunk = "Boss8" 
    GameLogic.enemyList[GameLogic.current_chunk].append(Boss8(7, 350 ,95)) #change this
